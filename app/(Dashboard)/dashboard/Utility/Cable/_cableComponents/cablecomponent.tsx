      ...
      <div className="grid grid-cols-12 space-x-0 md:space-x-8 lg:space-x-8">
        <form className="col-span-12 md:col-span-7 lg:col-span-7">
          ...
          >
            ...
            <option>ACT Cable TV</option>
            <option>Asianet Digital</option>
            <option>Airtel Cable</option>
            <option>Sun Cable Network</option>
            <option>In Digital</option>
            <option>V Digital</option>
...
export default memo(CableComponent);
