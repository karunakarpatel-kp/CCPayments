...
import VehicleChallanComponent from "./_vehicleChallanComponents/vehicleChallanComponent";

const VehicleChallanPage = () => {
  ...
  return (
    <section>
      ...
      <div className="">
        <VehicleChallanComponent />
      </div>
    </section>
  );
};

export default VehicleChallanPage;
