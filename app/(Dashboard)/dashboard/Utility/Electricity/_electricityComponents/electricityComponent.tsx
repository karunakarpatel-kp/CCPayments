        ...
        <form className="col-span-12 md:col-span-7 lg:col-span-7">
          ...
          <div className=" grid grid-cols-12 py-2 space-x-1">
            <input
              ...
              className="block appearance-none w-full  border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 col-span-12 md:col-span-6 lg:col-span-6 mb-3 lg:mb-0 md:mb-0"
              required
            />
            <input
              type="text"
